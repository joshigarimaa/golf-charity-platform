...
import { AnimatedSection, AnimatedCard, AnimatedNumber } from '@/components/ui/AnimatedSection'
      ...
      <section className="border-y border-gray-800 py-10">
        <div className="max-w-6xl mx-auto px-6 grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
          {[
            ...
            <div key={stat.label}>
              <AnimatedNumber value={stat.value} className="text-3xl font-black text-green-400" />
      ...
      <section id="how-it-works" className="max-w-6xl mx-auto px-6 py-24">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {[
            ...
            <AnimatedCard key={item.step} delay={i * 0.15} className="bg-gray-900 border border-gray-800 rounded-2xl p-8 relative overflow-hidden">
        ...
        <div className="max-w-6xl mx-auto px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {[
              ...
              <AnimatedCard key={tier.match} delay={i * 0.15} className={`rounded-2xl p-8 border text-center ${
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
          ...
          <div className="grid grid-cols-2 gap-4">
            {displayCharities.map((charity, i) => (
              <AnimatedCard key={charity.name} delay={i * 0.1} className="bg-gray-900 border border-gray-800 hover:border-green-500/40 rounded-xl p-5 text-center transition-colors">
